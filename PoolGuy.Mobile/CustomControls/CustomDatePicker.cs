...
namespace PoolGuy.Mobile.CustomControls
{
    public class CustomDatePicker : DatePicker
    {
        ...
        public DateTime? _originalNullableDate = null;
      ...
      BindableProperty.Create(nameof(ShowClearButton), typeof(bool), typeof(CustomDatePicker), default(bool), defaultBindingMode: BindingMode.TwoWay);
        ...
        public void Cancel()
        {
            NullableDate = _originalNullableDate;
            _originalNullableDate = null;
        }
