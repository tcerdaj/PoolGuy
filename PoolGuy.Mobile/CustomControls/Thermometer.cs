...
namespace PoolGuy.Mobile.CustomControls
{
    ...
    BindableProperty.Create(nameof(Temperature), typeof(float), typeof(Thermometer), 0.0f, BindingMode.OneWayToSource, propertyChanged: OnTemperatureChanged);
        ...
        {
            Thermometer control = bindable as Thermometer;
    ...
    BindableProperty.Create(nameof(GlassColor), typeof(Color), typeof(Thermometer), Color.LightGray);
    ...
    BindableProperty.Create(nameof(FluidColor), typeof(Color), typeof(Thermometer), Color.Red);
    ...
    BindableProperty.Create(nameof(MarkerColor), typeof(Color), typeof(Thermometer), Color.LightGray);
    ...
    BindableProperty.Create(nameof(IndicatorColor), typeof(Color), typeof(Thermometer), Color.Black);
    ...
    BindableProperty.Create(nameof(IndicatorTextColor), typeof(Color), typeof(Thermometer), Color.Black);
        ...
        void FixMaxMin()
        {
            ...
            {
                MaxTemperature = (int)Temperature;
            }
